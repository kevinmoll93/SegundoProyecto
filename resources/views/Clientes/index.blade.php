...
<br>
<br>
<a href="{{url('clientes/create')}}" class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">Agregar cliente</a>
<br>
<br>
      ...
      <table class="min-w-full bg-white">
        ...
        <thead class="bg-gray-800 text-white">
          ...
          <th class="w-1/3 text-left py-3 px-4 uppercase font-semibold text-sm">DNI</th>
            <th class="w-1/3 text-left py-3 px-10 uppercase font-semibold text-sm">Empresa</th>
    ...
    <tbody class="text-gray-700">
       @foreach ($clientes as $cliente)
        <tr>
            ...
            <td class="w-1/3 text-left py-3 px-4">{{$cliente->Apellido}} {{$cliente->Nombre}}</td>
            <td class="w-1/3 text-left py-3 px-4">{{$cliente->DNI}}</td>
            <td class="w-1/3 text-left py-3 px-4">{{$cliente->Empresa}}</td>
            <td class="w-1/3 text-left py-3 px-4">{{$cliente->Direccion}}</td>
            <td class="text-left py-3 px-4">{{$cliente->Telefono}}</td>
            <td class="text-left py-3 px-4">{{$cliente->Correo}}</td>
            <td>
                <a class="w-1/3 text-left py-2 px-5 bg-transparent hover:bg-yellow-300 text-yellow-500 font-semibold hover:text-white py-2 px-4 border border-yellow-300 hover:border-transparent rounded" href="{{url('/clientes/'.$cliente->id.'/edit')}}">Editar</a> 
